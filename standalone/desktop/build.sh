...
javac -cp $JADE_JAR:$REACTIVEJADE_JAR:$HARDWARESNIFFER_JAR -d $CLASSES_PATH $SOURCE_FILES
jar -cvfm $DESKTOP_JAR Manifest.txt -C $CLASSES_PATH . $JADE_JAR $REACTIVEJADE_JAR $HARDWARESNIFFER_JAR
